...
void Window::createAnalysisResultGroupBox()
{
    ...
    // 1.
    AnalysisResultBox = new QGroupBox(tr("Analysis Result and Bug detection"));
    ...
    codeAnalysisGlobalVariablesBox = new QGroupBox(tr("Shared Resources"));
...
void Window::handleAnalysis()
{
    ...
    if(AnalysisPathFile.open(QIODevice::ReadOnly | QIODevice::Text))
    {
        ...
        while(!stream.atEnd())
        {
            ...
            qDebug() << "[StaticAnalyzer]: " << path_line;
        }
    }
    ...
    if(AnalysisGlobalVariablesFile.open(QIODevice::ReadOnly | QIODevice::Text))
    {
        ...
        while(!stream.atEnd())
        {
            ...
            qDebug() << "[StaticAnalyzer]: " << global_variable_line;
        }
    }
...
void Window::handleCodeViewer()
{
    ...
    QString CLANG_PATH("/home/posjkh/llvm/bin/");
